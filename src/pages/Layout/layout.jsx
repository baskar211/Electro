            ...
            <div class="bg-teal-600">
                <div class="mx-auto max-w-7xl py-3 px-3 sm:px-6 lg:px-8">
                    <div class="flex flex-col items-center justify-between lg:flex-row lg:justify-center">
                        ...
                        <div class="mt-2 w-full flex-shrink-0 lg:mt-0 lg:w-auto"><Link
        ...
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all ">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                    <input className="py-1.5 w-full bg-transparent outline-none border-none focus:border-none placeholder-gray-500" type="text" placeholder="Search products" />
            ...
            <div className='md:hidden flex  justify-center items-center gap-[1rem]'>
                <Link to={'/favorite'}>

<img className='md:hidden size-8 ' src="https://img.icons8.com/pulsar-line/48/hearts.png" alt="" />
                </Link>
                <Link to={'/cart'}>
<img className='md:hidden size-8 ' src="https://img.icons8.com/material-outlined/24/fast-cart.png" alt="" />
                </Link>

            <button onClick={() => open ? setOpen(false) : setOpen(true)} aria-label="Menu" className="sm:hidden">
                {/* Menu Icon SVG */}
                <img class="inline-block size-[3rem] rounded-full" src={ManPng} alt="Avatar"/>
